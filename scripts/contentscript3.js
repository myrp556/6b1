...
setInterval(function() {
	...
	//console.log("set speed "+fuckps);
}, 1000);

function sendDirectScript(scriptStr) {
	console.log ($("#tempSpeedScript"))
	console.log ($("#tempSpeedScript").size())
...
var Client = {
	...
	handleEvent: function() {
		...
		cutted_hash = a.reduce(function(pre, cur){return pre+'/'+cur});
		console.log(hash, id);
		console.log(cutted_hash);
		if (a.length >= 3 && this['_handle_' + a[0] + '/' + a[1] + '/' + a[2]]) {
			...
			console.log("go to _handle_"+a[0]+"("+id+")");
			this['_handle_' + a[0]](id);
		} else {
			console.log("go to _handle_"+hash+" && _handle_"+hash+"("+id+")");
	...
	'_handle_raid': function() {
		console.log("contentscript3 handle_raid");
