...
window.Engine = {
	...
	click: function(selector) {
		console.log("engine click "+selector);
	...
	observeWaveInfo: function() {
		console.log("engine observeWaveInfo");
	...
	waitUntilVisible: function(selector) {
		...
		congole.log('egine waiting visible:' + selector);
	...
	waitUntilInvisible: function(selector) {
		console.log("engine invisable" + selector);
		return new Promise(function(resolve) {
			if (!$(selector).is(":visible")) {
				resolve();
				return
	...
	waitOnce: function(selector) {
		console.log("engine wait once "+selector);
	...
	attack: function() {
		console.log("attack turn: "+this.turn);
